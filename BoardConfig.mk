...
LOCAL_PATH := device/4Good/S450m_4G

# inherit from the proprietary version
-include vendor/4Good/S450m_4G/BoardConfigVendor.mk
...
BOARD_CUSTOM_BOOTIMG_MK := device/4Good/S450m_4G/mkbootimg.mk
...
TARGET_PREBUILT_KERNEL := device/4Good/S450m_4G/prebuilt/kernel

#system.prop
TARGET_SYSTEM_PROP := device/4Good/S450m_4G/system.prop

# CMHW
BOARD_HARDWARE_CLASS := device/4Good/S450m_4G/cmhw/
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/4Good/S450m_4G/bluetooth
...
#recovery
TARGET_RECOVERY_FSTAB := device/4Good/S450m_4G/recovery/root/etc/twrp.fstab
...
BOARD_EGL_CFG := device/4Good/S450m_4G/configs/egl.cfg
...
# SELinux
BOARD_SEPOLICY_DIRS := \
       device/4Good/S450m_4G/sepolicy
